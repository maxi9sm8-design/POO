...
class Vehiculo(ABC):
    ...
    def precio_diario(self, valor):
        ...
        if valor <= 0:
            print(f"⚠️ Alerta: El precio ${valor} no es válido. Se asigna tarifa base de $30,000.")
...
class Camioneta(Vehiculo):
    ...
    def calcular_cotizacion(self, dias, pasajeros=0):
        print(f"🛡️ Incluye seguro 4x4: ${self.seguro:,.0f}/día")
...
class Camion(Vehiculo):
    ...
    def calcular_cotizacion(self, dias, pasajeros=0):
        print(f"⚖️ Incluye impuesto de carga pesada: ${self.impuesto:,.0f}")
...
class SistemaAlquiler:
    ...
    def iniciar(self):
        ...
        if pasajeros > auto.personas:
            ...
            print("💡 Le sugerimos un vehículo de la categoría 'Transporte' (más grande).")
